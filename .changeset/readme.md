...
This folder contains **pending release notes** for traforo. Each `.md` file describes one user-facing fix or feature that should appear in the next generated changelog.
